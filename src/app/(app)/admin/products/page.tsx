              ...
              <div className="space-y-3 p-3.5 rounded-lg bg-[#0d0d10] border border-zinc-800/80">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  <div className="flex items-center justify-between sm:justify-start gap-2">
                    <div className="font-medium text-zinc-200 text-xs flex items-center gap-1.5">
                      ...
                      <span className="px-2 py-0.5 rounded bg-zinc-800 text-zinc-300 font-mono text-[10px] whitespace-nowrap">
                  ...
                  <div className="flex items-center gap-1.5 shrink-0">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md bg-zinc-800 hover:bg-zinc-700 text-zinc-200 font-medium text-[11px] border border-zinc-700 transition-colors whitespace-nowrap cursor-pointer"
                    >
                ...
                <div className="space-y-2 max-h-56 overflow-y-auto pr-1 admin-scrollbar">
                  {editVariants.map((v, idx) => (
                    <div
                      key={idx}
                      className="p-2 rounded-lg bg-zinc-900/90 border border-zinc-800 space-y-1.5 sm:space-y-0 sm:flex sm:items-center sm:gap-2"
                    >
                      <div className="flex items-center gap-1.5 flex-1 min-w-0">
                        {v.sku && (
                          <span className="hidden sm:inline-block px-1.5 py-0.5 rounded bg-zinc-800 text-zinc-400 font-mono text-[9px] truncate max-w-[80px]" title={v.sku}>
                            {v.sku}
                          </span>
                        )}
                        <input
                          ...
                          className="w-1/2 sm:w-auto sm:flex-1 bg-[#0d0d10] border border-zinc-800 rounded-md px-2.5 py-1 text-zinc-100 placeholder-zinc-600 text-xs min-w-0"
                        />
                        <input
                          type="text"
                      ...
                      <div className="flex items-center justify-between sm:justify-end gap-2 shrink-0 pt-1 sm:pt-0 border-t sm:border-t-0 border-zinc-800/60">
                        <div className="flex items-center gap-1.5">
                          <span className="text-[10px] text-zinc-500 sm:hidden">Stock :</span>
                          <input
                            type="number"
                            placeholder="Stock"
                            value={v.stock}
