...
export default function AdsHubPage() {
  ...
  return (
    <div className="p-4 sm:p-6 md:p-10 space-y-6 sm:space-y-8 max-w-6xl mx-auto font-sans">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-200 dark:border-zinc-800/80">
        <div>
          <div className="flex items-center gap-2 mb-1">
            <span className="text-[11px] font-mono uppercase tracking-wider text-slate-500 dark:text-zinc-400">Marketing & Acquisition</span>
            <span className="text-slate-300 dark:text-zinc-600">•</span>
            <span className="text-[11px] text-slate-500 dark:text-zinc-400 font-mono">Multi-Canal COD Maroc</span>
          </div>
          <h1 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white tracking-tight flex items-center gap-2.5">
            <Zap className="w-5 h-5 text-emerald-600 dark:text-emerald-400" /> Pixels Publicitaires & Partenaires Ads
          </h1>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-slate-100 dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 hover:border-slate-300 dark:hover:border-zinc-700 text-slate-700 dark:text-zinc-300 hover:text-slate-900 dark:hover:text-white text-xs font-medium transition-colors shadow-xs cursor-pointer"
          >
      ...
      <div className="p-5 sm:p-6 rounded-2xl bg-white dark:bg-[#121215] border border-red-500/30 shadow-xs relative overflow-hidden space-y-3">
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-5">
          <div className="space-y-1.5 max-w-xl">
            <div className="flex items-center gap-2">
              <span className="px-2.5 py-0.5 rounded-full text-[10px] font-mono uppercase tracking-wider bg-red-500/10 dark:bg-red-500/20 text-red-600 dark:text-red-400 border border-red-500/30 dark:border-red-500/40">
                Offre Partenaire Officiel
              </span>
              <span className="text-xs font-medium text-slate-500 dark:text-zinc-400">Pinterest Ads</span>
            </div>
          ...
          <div className="bg-slate-50 dark:bg-[#09090b] p-3.5 rounded-xl border border-slate-200 dark:border-zinc-800 shrink-0 w-full lg:w-80 space-y-2.5">
            <label className="text-[11px] font-medium text-slate-700 dark:text-zinc-300 block">
            ...
            <input
              ...
              className="w-full px-3 py-1.5 rounded-lg bg-white dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 text-slate-900 dark:text-zinc-100 font-mono text-xs outline-none focus:border-red-500/60 focus:ring-2 focus:ring-red-500/20"
            />
            <button
              type="button"
      ...
      <form onSubmit={handleSavePixels} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {/* Card 1: Meta Pixel */}
          <div className="p-5 rounded-2xl bg-white dark:bg-[#121215] border border-slate-200 dark:border-zinc-800/80 space-y-4 flex flex-col justify-between hover:border-slate-300 dark:hover:border-zinc-700/80 transition-colors shadow-xs">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-blue-600 dark:text-blue-400 font-bold text-xs">
                    fb
                  </div>
                  <div>
                    <h3 className="text-xs font-bold uppercase tracking-wider text-blue-600 dark:text-blue-400">Meta Pixel</h3>
                    <p className="text-[10px] text-slate-500 dark:text-zinc-500">Facebook & Instagram Ads</p>
                  </div>
                </div>
                ...
                <button
                  ...
                  className={`w-9 h-5 flex items-center rounded-full p-0.5 transition-colors cursor-pointer border ${
                    metaEnabled ? 'bg-emerald-500/20 border-emerald-500/60' : 'bg-slate-200 dark:bg-zinc-800 border-slate-300 dark:border-zinc-700'
                  }`}
                  title={metaEnabled ? 'Pixel actif' : 'Pixel inactif'}
                >
                  <span
                    className={`w-3.5 h-3.5 rounded-full transition-transform transform shadow-xs ${
                      metaEnabled ? 'translate-x-4 bg-emerald-500' : 'translate-x-0 bg-slate-400 dark:bg-zinc-400'
                    }`}
                  />
                </button>
              </div>
              ...
              <div className="space-y-1 pt-1">
                <label className="text-[11px] font-medium text-slate-700 dark:text-zinc-300 block">Identifiant Pixel (15-16 chiffres)</label>
                <input
                  type="text"
                  placeholder="Ex: 1386256236443220"
                  value={metaPixelId}
                  onChange={(e) => setMetaPixelId(e.target.value)}
                  className="w-full px-3 py-2 rounded-lg bg-slate-50 dark:bg-zinc-950 border border-slate-200 dark:border-zinc-800 text-slate-900 dark:text-zinc-100 font-mono text-xs outline-none focus:border-emerald-500/60 focus:ring-2 focus:ring-emerald-500/20"
                />
              </div>
            </div>

            {/* Card Footer: Instant Status Ping */}
            <div className="pt-2 border-t border-slate-200 dark:border-zinc-800/60 flex items-center justify-between text-xs">
              <div className="text-[11px] font-mono">
                {pings.meta?.loading ? (
                  <span className="text-slate-500 dark:text-zinc-500 flex items-center gap-1">
                    <RefreshCw className="w-3 h-3 animate-spin text-sky-500" /> Ping en cours...
                  </span>
                ) : pings.meta?.message ? (
                  <span className={pings.meta.valid ? 'text-emerald-600 dark:text-emerald-400' : 'text-sky-600 dark:text-sky-400'}>
                    {pings.meta.message}
                  </span>
                ) : (
                  <span className={metaPixelId && metaEnabled ? 'text-emerald-600 dark:text-emerald-400/90' : 'text-slate-400 dark:text-zinc-500'}>
              ...
              <button
                ...
                className="px-2.5 py-1 rounded-md bg-slate-100 hover:bg-slate-200 border border-slate-200 text-slate-700 dark:bg-zinc-900 dark:hover:bg-zinc-800 dark:border-zinc-800 dark:text-zinc-300 dark:hover:text-white text-[11px] font-mono transition-colors cursor-pointer"
              >
                Ping / Tester
              </button>
            </div>
          ...
          <div className="p-5 rounded-2xl bg-white dark:bg-[#121215] border border-slate-200 dark:border-zinc-800/80 space-y-4 flex flex-col justify-between hover:border-slate-300 dark:hover:border-zinc-700/80 transition-colors shadow-xs">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg bg-teal-500/10 border border-teal-500/20 flex items-center justify-center text-teal-600 dark:text-teal-400 font-bold text-xs">
                    tt
                  </div>
                  <div>
                    <h3 className="text-xs font-bold uppercase tracking-wider text-teal-600 dark:text-teal-400">TikTok Pixel</h3>
                    <p className="text-[10px] text-slate-500 dark:text-zinc-500">TikTok Ads Maroc</p>
                  </div>
                </div>
                ...
                <button
                  ...
                  className={`w-9 h-5 flex items-center rounded-full p-0.5 transition-colors cursor-pointer border ${
                    tiktokEnabled ? 'bg-emerald-500/20 border-emerald-500/60' : 'bg-slate-200 dark:bg-zinc-800 border-slate-300 dark:border-zinc-700'
                  }`}
                  title={tiktokEnabled ? 'Pixel actif' : 'Pixel inactif'}
                >
                  <span
                    className={`w-3.5 h-3.5 rounded-full transition-transform transform shadow-xs ${
                      tiktokEnabled ? 'translate-x-4 bg-emerald-500' : 'translate-x-0 bg-slate-400 dark:bg-zinc-400'
                    }`}
                  />
                </button>
              </div>
              ...
              <div className="space-y-1 pt-1">
                <label className="text-[11px] font-medium text-slate-700 dark:text-zinc-300 block">TikTok Pixel Code (20 caractères)</label>
                <input
                  type="text"
            ...
            <div className="pt-2 border-t border-slate-200 dark:border-zinc-800/60 flex items-center justify-between text-xs">
              <div className="text-[11px] font-mono">
                {pings.tiktok?.loading ? (
                  ...
                  <span className={pings.tiktok.valid ? 'text-emerald-600 dark:text-emerald-400' : 'text-sky-600 dark:text-sky-400'}>
                    {pings.tiktok.message}
                  </span>
                ) : (
                  <span className={tiktokPixelId && tiktokEnabled ? 'text-emerald-600 dark:text-emerald-400/90' : 'text-slate-400 dark:text-zinc-500'}>
          ...
          <div className="p-5 rounded-2xl bg-white dark:bg-[#121215] border border-slate-200 dark:border-zinc-800/80 space-y-4 flex flex-col justify-between hover:border-slate-300 dark:hover:border-zinc-700/80 transition-colors shadow-xs">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg bg-yellow-500/10 border border-yellow-500/20 flex items-center justify-center text-yellow-600 dark:text-yellow-400 font-bold text-xs">
                    snap
                  </div>
                  <div>
                    <h3 className="text-xs font-bold uppercase tracking-wider text-yellow-600 dark:text-yellow-400">Snapchat Pixel</h3>
                    <p className="text-[10px] text-slate-500 dark:text-zinc-500">Snap Pixel CAPI</p>
                  </div>
                </div>
                ...
                <button
                  ...
                  className={`w-9 h-5 flex items-center rounded-full p-0.5 transition-colors cursor-pointer border ${
                    snapEnabled ? 'bg-emerald-500/20 border-emerald-500/60' : 'bg-slate-200 dark:bg-zinc-800 border-slate-300 dark:border-zinc-700'
                  }`}
                  title={snapEnabled ? 'Pixel actif' : 'Pixel inactif'}
                >
                  <span
                    className={`w-3.5 h-3.5 rounded-full transition-transform transform shadow-xs ${
                      snapEnabled ? 'translate-x-4 bg-emerald-500' : 'translate-x-0 bg-slate-400 dark:bg-zinc-400'
                    }`}
                  />
                </button>
              </div>
              ...
              <div className="space-y-1 pt-1">
                <label className="text-[11px] font-medium text-slate-700 dark:text-zinc-300 block">Snap Pixel ID (UUID format)</label>
                <input
                  type="text"
            ...
            <div className="pt-2 border-t border-slate-200 dark:border-zinc-800/60 flex items-center justify-between text-xs">
              <div className="text-[11px] font-mono">
                {pings.snap?.loading ? (
                  ...
                  <span className={pings.snap.valid ? 'text-emerald-600 dark:text-emerald-400' : 'text-sky-600 dark:text-sky-400'}>
                    {pings.snap.message}
                  </span>
                ) : (
                  <span className={snapchatPixelId && snapEnabled ? 'text-emerald-600 dark:text-emerald-400/90' : 'text-slate-400 dark:text-zinc-500'}>
          ...
          <div className="p-5 rounded-2xl bg-white dark:bg-[#121215] border border-slate-200 dark:border-zinc-800/80 space-y-4 flex flex-col justify-between hover:border-slate-300 dark:hover:border-zinc-700/80 transition-colors shadow-xs">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg bg-sky-500/10 border border-sky-500/20 flex items-center justify-center text-sky-600 dark:text-sky-400 font-bold text-xs">
                    g4
                  </div>
                  <div>
                    <h3 className="text-xs font-bold uppercase tracking-wider text-sky-600 dark:text-sky-400">Google Tag</h3>
                    <p className="text-[10px] text-slate-500 dark:text-zinc-500">Google Analytics 4 & Ads</p>
                  </div>
                </div>
                ...
                <button
                  ...
                  className={`w-9 h-5 flex items-center rounded-full p-0.5 transition-colors cursor-pointer border ${
                    googleEnabled ? 'bg-emerald-500/20 border-emerald-500/60' : 'bg-slate-200 dark:bg-zinc-800 border-slate-300 dark:border-zinc-700'
                  }`}
                  title={googleEnabled ? 'Tag actif' : 'Tag inactif'}
                >
                  <span
                    className={`w-3.5 h-3.5 rounded-full transition-transform transform shadow-xs ${
                      googleEnabled ? 'translate-x-4 bg-emerald-500' : 'translate-x-0 bg-slate-400 dark:bg-zinc-400'
                    }`}
                  />
                </button>
              </div>
              ...
              <div className="space-y-1 pt-1">
                <label className="text-[11px] font-medium text-slate-700 dark:text-zinc-300 block">Measurement ID (G-...)</label>
                <input
                  type="text"
            ...
            <div className="pt-2 border-t border-slate-200 dark:border-zinc-800/60 flex items-center justify-between text-xs">
              <div className="text-[11px] font-mono">
                {pings.google?.loading ? (
                  ...
                  <span className={pings.google.valid ? 'text-emerald-600 dark:text-emerald-400' : 'text-sky-600 dark:text-sky-400'}>
                    {pings.google.message}
                  </span>
                ) : (
                  <span className={googleAnalyticsId && googleEnabled ? 'text-emerald-600 dark:text-emerald-400/90' : 'text-slate-400 dark:text-zinc-500'}>
          ...
          <div className="p-5 rounded-2xl bg-white dark:bg-[#121215] border border-slate-200 dark:border-zinc-800/80 space-y-4 flex flex-col justify-between hover:border-slate-300 dark:hover:border-zinc-700/80 transition-colors shadow-xs">
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <div className="w-8 h-8 rounded-lg bg-red-500/10 border border-red-500/20 flex items-center justify-center text-red-600 dark:text-red-400 font-bold text-xs">
                    pin
                  </div>
                  <div>
                    <h3 className="text-xs font-bold uppercase tracking-wider text-red-600 dark:text-red-400">Pinterest Tag</h3>
                    <p className="text-[10px] text-slate-500 dark:text-zinc-500">Tracking Officiel pintrk</p>
                  </div>
                </div>
                ...
                <button
                  ...
                  className={`w-9 h-5 flex items-center rounded-full p-0.5 transition-colors cursor-pointer border ${
                    pinterestEnabled ? 'bg-emerald-500/20 border-emerald-500/60' : 'bg-slate-200 dark:bg-zinc-800 border-slate-300 dark:border-zinc-700'
                  }`}
                  title={pinterestEnabled ? 'Tag actif' : 'Tag inactif'}
                >
                  <span
                    className={`w-3.5 h-3.5 rounded-full transition-transform transform shadow-xs ${
                      pinterestEnabled ? 'translate-x-4 bg-emerald-500' : 'translate-x-0 bg-slate-400 dark:bg-zinc-400'
                    }`}
                  />
                </button>
              </div>
              ...
              <div className="space-y-1 pt-1">
                <label className="text-[11px] font-medium text-slate-700 dark:text-zinc-300 block">Pinterest Tag ID (13 chiffres)</label>
                <input
                  type="text"
            ...
            <div className="pt-2 border-t border-slate-200 dark:border-zinc-800/60 flex items-center justify-between text-xs">
              <div className="text-[11px] font-mono">
                {pings.pinterest?.loading ? (
                  ...
                  <span className={pings.pinterest.valid ? 'text-emerald-600 dark:text-emerald-400' : 'text-sky-600 dark:text-sky-400'}>
                    {pings.pinterest.message}
                  </span>
                ) : (
                  <span className={pinterestPartnerId && pinterestEnabled ? 'text-emerald-600 dark:text-emerald-400/90' : 'text-slate-400 dark:text-zinc-500'}>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h3 className="text-xs font-bold uppercase tracking-wider text-blue-600 dark:text-blue-400">Merchant Center</h3>
                    <p className="text-[10px] text-slate-500 dark:text-zinc-500">Google Shopping Maroc (Flux)</p>
                  </div>
                </div>
                ...
                <button
                  ...
                  className={`w-9 h-5 flex items-center rounded-full p-0.5 transition-colors cursor-pointer border ${
                    gmcEnabled ? 'bg-emerald-500/20 border-emerald-500/60' : 'bg-slate-200 dark:bg-zinc-800 border-slate-300 dark:border-zinc-700'
                  }`}
                  title={gmcEnabled ? 'Flux actif' : 'Flux inactif'}
                >
                  <span
                    className={`w-3.5 h-3.5 rounded-full transition-transform transform shadow-xs ${
                      gmcEnabled ? 'translate-x-4 bg-emerald-500' : 'translate-x-0 bg-slate-400 dark:bg-zinc-400'
                    }`}
                  />
                </button>
              </div>
              ...
              <div className="space-y-1 pt-1">
                <label className="text-[11px] font-medium text-slate-700 dark:text-zinc-300 block">Merchant Center ID</label>
                <input
                  type="text"
            ...
            <div className="pt-2 border-t border-slate-200 dark:border-zinc-800/60 flex items-center justify-between text-xs">
              <div className="text-[11px] font-mono">
                {pings.gmc?.loading ? (
                  ...
                  <span className={pings.gmc.valid ? 'text-emerald-600 dark:text-emerald-400' : 'text-sky-600 dark:text-sky-400'}>
                    {pings.gmc.message}
                  </span>
                ) : (
                  <span className={googleMerchantCenterId && gmcEnabled ? 'text-emerald-600 dark:text-emerald-400/90' : 'text-slate-400 dark:text-zinc-500'}>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-3 border-t border-slate-200 dark:border-zinc-800/80">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              type="submit"
              disabled={saving}
              className="flex items-center gap-2 px-5 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white font-semibold text-xs transition-colors shadow-xs shadow-emerald-500/20 cursor-pointer"
            >
