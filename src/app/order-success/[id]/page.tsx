...
import { CheckCircle2, PhoneCall, Truck, Banknote, MessageCircle, ArrowLeft } from 'lucide-react';
    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-16 text-center space-y-8">
      ...
      <div className="space-y-2">
        ...
        <p className="text-xs sm:text-sm text-zinc-600 max-w-md mx-auto">
          Votre commande <span className="font-mono font-bold text-zinc-900">#{orderId}</span> a bien été transmise à notre équipe de préparation.
        </p>
      </div>
          ...
          <div className="flex items-start gap-3.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-zinc-500 mt-0.5">
                Notre agent va vous appeler dans les prochaines heures pour confirmer votre adresse et convenir de l'horaire de livraison.
              </p>
            </div>
          </div>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
        <a
          href={`https://wa.me/212661000000?text=Salam,%20je%20viens%20de%20passer%20la%20commande%20n°%20${orderId}`}
          target="_blank"
