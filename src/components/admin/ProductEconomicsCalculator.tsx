...
export const ProductEconomicsCalculator: React.FC<ProductEconomicsCalculatorProps> = ({
  ...
  return (
    <div className="bg-[#0f0f12] border border-zinc-800 rounded-xl p-4 sm:p-5 text-zinc-100 shadow-xl space-y-4">
      {/* Header */}
      <div className="flex items-center justify-between border-b border-zinc-800/80 pb-3">
        ...
        {compact && (
          <button
            ...
            className="text-xs text-zinc-400 hover:text-zinc-200 flex items-center gap-1 p-1 rounded hover:bg-zinc-800/60"
          >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
        <div className="p-3 rounded-lg bg-zinc-900/80 border border-zinc-800/80">
          <div className="text-[11px] text-zinc-400">Marge Brute Unitaire</div>
          <div className="text-base font-mono tabular-nums font-bold text-zinc-100 mt-0.5">
            +{economics.grossMarginMAD} MAD
          </div>
          <div className="text-[10px] font-mono tabular-nums text-zinc-400 mt-0.5">
            ({economics.grossMarginPercent}% du PV)
          </div>
        </div>

        <div className="p-3 rounded-lg bg-zinc-900/80 border border-zinc-800/80">
          <div className="text-[11px] text-zinc-400">Bénéfice Net Réel / Colis</div>
          <div
            className={`text-base font-mono tabular-nums font-bold mt-0.5 ${
              economics.netProfitMAD > 0 ? 'text-emerald-400' : 'text-rose-400'
            }`}
          >
        ...
        <div className="p-3 rounded-lg bg-zinc-900/80 border border-zinc-800/80">
          <div className="text-[11px] text-zinc-400">Marge Nette Réelle (%)</div>
          <div
            className={`text-base font-mono tabular-nums font-bold mt-0.5 ${
        ...
        <div className="p-3 rounded-lg bg-zinc-900/80 border border-zinc-800/80">
          <div className="text-[11px] text-zinc-400">CPA Max (Break-even Pub)</div>
          <div className="text-base font-mono tabular-nums font-bold text-cyan-400 mt-0.5">
      ...
      {isExpanded && (
        <div className="space-y-4 pt-1">
          {/* Inputs Section */}
          <div className="p-3.5 rounded-lg bg-zinc-900/50 border border-zinc-800/80 space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#09090b] border border-zinc-800 rounded-lg px-2.5 py-1.5 text-xs font-mono tabular-nums font-semibold text-zinc-100 focus:outline-none focus:border-zinc-600"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#09090b] border border-zinc-800 rounded-lg px-2.5 py-1.5 text-xs font-mono tabular-nums font-semibold text-emerald-400 focus:outline-none focus:border-zinc-600"
                />
              </div>
            ...
            {/* Slider: Return Rate */}
            <div className="pt-1.5 border-t border-zinc-800/60 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
              <div className="flex items-center gap-2">
                <RotateCcw className="w-3.5 h-3.5 text-zinc-400" />
                <span className="text-[11px] text-zinc-300">
                  Taux de Retour Estimé (Moyenne Maroc : 10% à 20%) :
                </span>
                <span className="font-mono tabular-nums font-semibold text-zinc-100 text-xs">
                  {returnRatePercent}%
                </span>
              </div>
              <input
          ...
          <div className="space-y-3 pt-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              {/* Solo Card */}
              <div className="p-3.5 rounded-lg bg-zinc-900/60 border border-zinc-800/80 flex flex-col justify-between">
                <div>
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-semibold text-zinc-200">Pack Solo (1 Unité)</span>
                    <span className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-zinc-800 text-zinc-400">
                      Standard
                    </span>
                  </div>
                  <div className="text-base font-mono tabular-nums font-bold text-zinc-100 mt-2">
              ...
              {/* Pack Duo Card */}
              <div className="p-3.5 rounded-lg bg-purple-950/20 border border-purple-800/40 relative flex flex-col justify-between">
                ...
                <div>
                  <div className="flex items-center justify-between">
                    <span className="text-xs font-semibold text-purple-200">Pack Duo (2 Unités)</span>
                  </div>
                  <div className="text-base font-mono tabular-nums font-bold text-zinc-100 mt-2">
                    {packs.duo.sellingPrice} MAD
                    <span className="text-[10px] line-through text-zinc-500 font-normal ml-2">
                      {sellingPrice * 2} MAD
                    </span>
                  </div>
                ...
                <div className="mt-3 pt-2.5 border-t border-purple-800/30 space-y-1">
                  <div className="flex justify-between text-xs">
                    <span className="text-purple-300">Bénéfice Net :</span>
          ...
          <div className="p-3.5 rounded-lg bg-zinc-900/60 border border-zinc-800/80 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
            <div className="flex items-center gap-2">
              <TrendingUp className="w-4 h-4 text-emerald-400" />
              <div>
                <span className="text-zinc-300 font-medium">Seuil de Rentabilité Quotidienne :</span>
            ...
            <div className="flex items-center gap-3">
              <div className="text-right">
                <div className="text-[11px] text-zinc-400">Point mort (0 DH perte)</div>
              ...
              <div className="text-right">
                <div className="text-[11px] text-zinc-400">Gain Net à {dailyOrdersTarget} colis/j</div>
                <div
                  className={`font-mono tabular-nums font-bold ${
                    dailyProjections.netDailyProfitMAD >= 0 ? 'text-emerald-400' : 'text-rose-400'
                  }`}
                >
          ...
          {onApplyPricing && (
            <div className="pt-2 flex justify-end">
              <button
                ...
                className="px-4 py-1.5 rounded-lg bg-zinc-100 hover:bg-white text-zinc-900 font-semibold text-xs transition-colors"
              >
